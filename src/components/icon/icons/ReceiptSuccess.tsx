...
export default function ReceiptSuccess() {
  ...
  <path d="M52.5 33C44.772 33 38.5 39.272 38.5 47C38.5 54.728 44.772 61 52.5 61C60.228 61 66.5 54.728 66.5 47C66.5 39.272 60.228 33 52.5 33Z" fill="#5CB85C"/>
  <path d="M46.5 47.5517L50.2241 51.2759L58.5 43" stroke="white" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>`
